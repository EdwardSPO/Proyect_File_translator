<template>
    ...
    <div class="container">
      <div class="mb-3">
        ...
        <label class="input-group-text " for="inputGroupSelect01" id="from">Translate from</label>
       ...
       <div class="flex-wrap input-group mb-3">
        <label class="input-group-text" for="inputGroupSelect01" id="into">Translate into</label>
